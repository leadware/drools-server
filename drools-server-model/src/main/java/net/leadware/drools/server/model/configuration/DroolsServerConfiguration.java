 ...
 *       &lt;sequence>
 *         &lt;element name="knowledge-session" type="{http://www.leadware.net/drools-server-configuration}KnowledgeSessionConfiguration" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class DroolsServerConfiguration {
    ...
    @XmlElement(name = "knowledge-session", namespace = "http://www.leadware.net/drools-server-configuration")
